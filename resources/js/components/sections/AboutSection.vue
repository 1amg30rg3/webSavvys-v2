...
<template>
    <section class="section-background-light about-section" id="about" ref="sectionRef">
        <div class="about-inner">
            ...
            <div class="about-grid-wrap" data-animate="fade-up" style="--delay: 0.15s" aria-hidden="true">
                ...
                <div class="metric-grid">
                    ...
                    <div class="m-card" style="--pulse-delay: 0s; --pulse-color: rgba(45,180,164,0.2);">
                        <span class="m-icon">⚡</span>
                        <span class="m-label">{{ t('about.metrics.perfScore') }}</span>
                        <span class="m-value" style="color: var(--accent-2)">99</span>
                        <div class="m-bar">
                    ...
                    <div class="m-card" style="--pulse-delay: 0.7s; --pulse-color: rgba(255,106,91,0.15);">
                        <span class="m-icon">🛠</span>
                        <span class="m-label">{{ t('about.metrics.delivered') }}</span>
                        <span class="m-value">120+</span>
                    </div>

                    <div class="m-card" style="--pulse-delay: 1.4s; --pulse-color: rgba(248,194,78,0.15);">
                        <span class="m-icon">🧩</span>
                    ...
                    <div class="m-card m-card--wide" style="--pulse-delay: 0.35s; --pulse-color: rgba(255,106,91,0.1);">
                        ...
                        <div class="m-card-body">
                            ...
                            <div class="m-bar">
                                <div class="m-bar-fill" style="--from: 55%; --to: 90%; --bar-dur: 4s; --bar-delay: 1s; background: linear-gradient(90deg, var(--accent), var(--accent-3));"></div>
                            </div>
                        </div>
                    </div>

                    <div class="m-card" style="--pulse-delay: 1.9s; --pulse-color: rgba(45,180,164,0.2);">
                        <div class="m-live">
                            <span class="m-dot"></span>
                            <span class="m-label" style="margin-bottom: 0;">{{ t('about.metrics.live') }}</span>
                        </div>
                        <span class="m-label">{{ t('about.metrics.uptime') }}</span>
                        <span class="m-value" style="color: var(--accent-2)">99.9%</span>
                    </div>

                    <div class="m-card" style="--pulse-delay: 1.1s; --pulse-color: rgba(255,106,91,0.15);">
                        <span class="m-icon">✦</span>
                    ...
                    <div class="m-card" style="--pulse-delay: 0.5s; --pulse-color: rgba(248,194,78,0.15);">
                        <span class="m-icon">🎯</span>
                        <span class="m-label">{{ t('about.metrics.uxScore') }}</span>
                        <span class="m-value">A+</span>
                    </div>

                    <div class="m-card m-card--wide" style="--pulse-delay: 0.9s; --pulse-color: rgba(45,180,164,0.12);">
                        <span class="m-icon m-icon--lg">🔄</span>
                        <div class="m-card-body">
                            ...
                            <div class="m-bar">
                                <div class="m-bar-fill" style="--from: 65%; --to: 95%; --bar-dur: 3.5s; --bar-delay: 0.5s; background: linear-gradient(90deg, var(--accent-2), var(--accent-3));"></div>
                            </div>
                        </div>
                    </div>
